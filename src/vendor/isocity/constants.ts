 ...
 */
import waterAsset from '../../assets/isocity/water.webp';
import { BuildingType } from './model';
import { DirectionMeta } from './model';
...
export const PEDESTRIAN_MAX_COUNT = 120; // QALA overview visibility / bounded ambient population.
export const PEDESTRIAN_MAX_COUNT_MOBILE = 48; // QALA overview visibility / bounded ambient population.
...
export const CAR_MIN_ZOOM = 0.25; // QALA overview visibility / bounded ambient population.
export const CAR_MIN_ZOOM_MOBILE = 0.25; // QALA overview visibility / bounded ambient population.
export const PEDESTRIAN_MIN_ZOOM = 0.3; // QALA overview visibility / bounded ambient population.
export const PEDESTRIAN_MIN_ZOOM_MOBILE = 0.3; // QALA overview visibility / bounded ambient population.
...
export const TRAIN_MIN_ZOOM_FAR = 0.2; // Trains visible slightly further out than cars
export const BOAT_MIN_ZOOM_FAR = 0.2; // Boats visible at moderate zoom
export const HELICOPTER_MIN_ZOOM_FAR = 0.2; // Helicopters visible at moderate zoom
...
export const AIRPLANE_SPRITE_SRC = ''; // Aircraft assets are not part of QALA's visual layer.
...
export const PLANE_TYPES: Array<'737' | '777' | '747' | 'a380' | 'g650'> = [
  '737',
  '737',
  '737',
  '777',
...
export const PLANE_DIRECTION_COLS: Record<
  string,
  { col: number; mirrorX: boolean; mirrorY: boolean; baseAngle: number }
> = {
...
export const COL1_DIRECTION_OVERRIDES: Record<
  string,
  { col: number; mirrorX: boolean; mirrorY: boolean; baseAngle: number }
> = {
...
// Water asset path
export const WATER_ASSET_PATH = waterAsset;
...
export const FIREWORK_BUILDINGS: BuildingType[] = [
  'baseball_stadium',
  'amusement_park',
  'marina_docks_small',
  'pier_large',
...
export const NON_LIT_BUILDING_TYPES = new Set([
  'grass',
  'empty',
  'water',
  'road',
...
export const COMMERCIAL_BUILDING_TYPES = new Set([
  'shop_small',
  'shop_medium',
  'office_low',
  'office_high',
...
export const CLOUD_TYPE_WEIGHTS_BY_HOUR: Record<number, [number, number, number, number, number]> =
  {
    ...
    3: [2, 4, 5, 0, 3],
    4: [2, 4, 5, 0, 3],
    5: [3, 5, 4, 0, 4], // Pre-dawn: stratus, cirrus
    6: [4, 6, 3, 0, 5],
    7: [5, 5, 3, 0, 5],
    8: [6, 4, 3, 0, 5],
    9: [7, 3, 3, 0, 4], // Morning: stratus burns off, cumulus builds
    10: [8, 2, 4, 1, 4],
    11: [9, 2, 4, 1, 3],
    12: [9, 2, 4, 2, 3],
    13: [8, 2, 4, 3, 3], // Midday: cumulus dominant, afternoon storm chance
    14: [8, 2, 4, 3, 3],
    15: [7, 2, 4, 3, 4],
    16: [6, 3, 4, 2, 4], // Late afternoon: cumulonimbus
    17: [5, 4, 4, 2, 5],
    18: [4, 5, 4, 1, 6],
    19: [3, 5, 5, 1, 5], // Evening: altocumulus, stratus
    20: [2, 5, 5, 0, 4],
    21: [2, 4, 5, 0, 3],
    22: [2, 4, 5, 0, 3],
    23: [2, 4, 5, 0, 3], // Night: cirrus, stratus
  };
...
export const CLOUD_TYPES_ORDERED = [
  'cumulus',
  'stratus',
  'cirrus',
  'cumulonimbus',
...
export const CLOUD_TYPE_CONFIG: Record<
  string,
  {
    opacityMin: number;
    opacityMax: number;
