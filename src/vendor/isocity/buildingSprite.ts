...
import { Building, BuildingType } from './model';
import {
  SpritePack,
  getActiveSpritePack,
  getSpriteCoords,
...
import { getBuildingSize, requiresWaterAdjacency } from './model';
...
export function selectSpriteSource(
  ...
  const isUnderConstruction =
    building.constructionProgress !== undefined && building.constructionProgress < 100;
  ...
  if (
    activePack.servicesSrc &&
    activePack.servicesVariants &&
    activePack.servicesVariants[buildingType]
  ) {
  ...
  if (
    activePack.infrastructureSrc &&
    activePack.infrastructureVariants &&
    activePack.infrastructureVariants[buildingType]
  ) {
  ...
  if (
    activePack.mansionsSrc &&
    activePack.mansionsVariants &&
    activePack.mansionsVariants[buildingType]
  ) {
...
export function calculateSpriteScale(
  ...
  if (
    variantType === 'services' &&
    activePack.servicesScales &&
    buildingType in activePack.servicesScales
  ) {
  ...
  if (
    variantType === 'infrastructure' &&
    activePack.infrastructureScales &&
    buildingType in activePack.infrastructureScales
  ) {
  ...
  if (
    variantType === 'mansion' &&
    activePack.mansionsScales &&
    buildingType in activePack.mansionsScales
  ) {
    scaleMultiplier *= activePack.mansionsScales[buildingType];
  }

  if (
    (variantType === 'parks' || variantType === 'parksConstruction') &&
...
export function calculateSpriteOffsets(
  ...
  if (
    ...
    variantType === 'mansion' &&
    activePack.mansionsVerticalOffsets &&
  ...
  if (
    variantType === 'services' &&
    activePack.servicesHorizontalOffsets &&
  ...
  if (
    variantType === 'infrastructure' &&
    activePack.infrastructureHorizontalOffsets &&
