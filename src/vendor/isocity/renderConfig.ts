 ...
 */
import baseAsset from '../../assets/isocity/base.webp';
import denseAsset from '../../assets/isocity/dense.webp';
import modernAsset from '../../assets/isocity/modern.webp';
import parksAsset from '../../assets/isocity/parks.webp';
import servicesAsset from '../../assets/isocity/services.webp';
...
const SPRITE_PACK_SPRITES4: SpritePack = {
  ...
  buildingVerticalOffsets: {
    ...
    apartment_high: -0.6, // Shifted down ~0.4 tiles from -1.0
  },
  ...
  constructionScales: {
    ...
    office_high: 0.8, // Construction office_high scaled down 20%
    apartment_high: 0.65, // Construction apartment_high scaled down 35%
    apartment_low: 0.8, // Construction apartment_low scaled down 20%
  },
  ...
  denseVerticalOffsets: {
    ...
    apartment_high: -0.8, // Shifted up 0.2 tiles from -0.60
  ...
  parksVerticalOffsets: {
    ...
    playground_large: -0.6, // shifted down 0.05 from -0.65
    baseball_field_small: -0.55, // shifted down 0.3 from -0.85
    soccer_field_small: -0.2, // shifted up slightly
    ...
    swimming_pool: -0.2, // shifted up slightly
    skate_park: -0.25, // shifted up 0.1 tiles
    mini_golf_course: -0.6, // shifted up 0.05 tiles from -0.55
    bleachers_field: -0.2, // shifted down 0.1 tiles from -0.3
    go_kart_track: -0.3, // shifted down 0.1 tiles from -0.40
    amphitheater: -0.4, // shifted down 0.05 tiles from -0.45
    ...
    roller_coaster_small: -0.5, // shifted up 0.15 tiles from -0.35
  ...
  parksScales: {
    ...
    swimming_pool: 0.9, // scaled down 10% total (5% more from 0.95)
    soccer_field_small: 0.95, // scaled down 5%
    go_kart_track: 0.92, // scaled down 8%
    mini_golf_course: 0.95, // scaled down 5%
    amphitheater: 0.9, // scaled down 10%
    greenhouse_garden: 0.9, // scaled down 10%
  },
  ...
  shopsScales: {
    shop_small: 0.9, // Scale down 10% total
    shop_medium: 0.9, // Scale down 10% total
  },
  ...
  mansionsScales: {
    mansion: 0.9, // Same as modern apartment_high scale
  },
  buildingToSprite: {
...
// ============================================================================
export const SPRITE_PACKS: SpritePack[] = [SPRITE_PACK_SPRITES4];
...
export const SPRITE_SHEET = {
  get src() {
    return _activeSpritePack.src;
  },
  get cols() {
    return _activeSpritePack.cols;
  },
  get rows() {
    return _activeSpritePack.rows;
  },
  get layout() {
    return _activeSpritePack.layout;
  },
};
