...
Код, Three.js, стильдер, деректер және сурет бір HTML файлына енгізілген. Ойын алғаш ашылғанда да офлайн жұмыс істейді. WebGL болмаса, суретті карта мен толық ойын логикасы қолжетімді. Браузер рұқсат етсе, ойын сақталады; нәтижені JSON түрінде экспорттауға болады.
...
- Интерактивті Three.js картасы: бес аудан, бұру, үлкейту, өмір сапасы қабаты және қабылданған шаралардың белгілері.
...
**React + TypeScript + Vite + Three.js.** `src/game/engine.ts` модулі шешімдерді тексеріп, барлық санды есептейді. Интерфейс пен карта осы нәтижені пайдаланады. Дерекқор немесе CDN қажет емес; қолданба бір HTML файлына жиналады.
